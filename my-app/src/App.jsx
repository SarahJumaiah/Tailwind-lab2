      ...
      <section className=" py-16 px-20 bg-gray-50">
        <div className="container mx-auto flex flex-col md:flex-row items-center">
          <div className="md:w-1/2">
            <img src="https://d9hhrg4mnvzow.cloudfront.net/templates.unbounce.com/freshgoods/ef9d9b9f-freshgoods-about_100000000000000000001o.jpg" alt="Owner" className="w-1/2 h-auto ml-12" />
          </div>
          <div className="md:w-1/2 text-left">
            <h3 className="text-2xl font-bold mb-4">Some more information about your business</h3>
            <p className="text-gray-600">Share a little about yourself as a business owner, or maybe describe what makes your product or service unique. Give visitors one more reason to care about your offer and want to buy from you.</p>
          </div>
        </div>
      </section>

      <section className="p-5 py-16 text-center bg-gray-200">
        <h1 className="text-4xl font-bold mb-4">End with one final call to action</h1>
        <p className="text-gray-600 mb-8">This is your last shot at converting someone. Remind them about the benefits of your offer and encourage them to act now.</p>
        <button className="bg-yellow-500 text-black py-2 px-4 rounded">Order Now</button>
      </section>
      <Footer />
    </div>
  );
